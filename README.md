...
**Independent Demos:**
- **Demo 03** - Uses different dataset (Japanese employee data), can run standalone
- **Demo 06** - Requires Demos 01+02 (uses Athena table), creates separate DynamoDB table
